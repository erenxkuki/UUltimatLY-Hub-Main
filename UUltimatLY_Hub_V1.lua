...
BringEnemy = function()
	...
	Tabs.Discord:AddButton({
		...
		Description = "",
		Callback = function()
			setclipboard(tostring("https://discord.gg/dtkbvtrM7G"))
		end
	})
	...
	local TravelDress = Tabs.Main:AddToggle("TravelDress", {
		...
		Description = "Automatically go to Sea 2 (requires level 700).",
		Default = false
	})
	...
	local Zou = Tabs.Main:AddToggle("Zou", {
		...
		Description = "Automatically go to Sea 3 (requires level 1500).",
		Default = false
	})
	...
	local FarmPhaBinh = Tabs.Main:AddToggle("FarmPhaBinh", {
		...
		Description = "Break the boss summoning jar.",
		Default = false
	})
	...
	local FactoryRaids = Tabs.Main:AddToggle("FactoryRaids", {
		...
		Description = "Auto Attack the Factory Raid.",
		Default = false
	})
	...
	local CastleRaids = Tabs.Main:AddToggle("CastleRaids", {
		...
		Description = "Auto Attack the Pirate Raid.",
		Default = false
	})
	...
	Toggle = Tabs.Main:AddToggle("Toggle", {
		...
		Description = "Auto-farm materials",
		Default = false
	})
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Farm Ectoplasm materials.",
		Default = false
	})
	...
	local Bartilo = Tabs.Main:AddToggle("Bartilo", {
		Title = "Auto complete Bartilo quest.",
		Description = "",
		Default = false
	})
	...
	local CitizenQ = Tabs.Main:AddToggle("CitizenQ", {
		Title = "Auto complete the Citizen quest.",
		Description = "",
		Default = false
	})
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Auto Farm Mirror Fractal",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.Main:AddSection("Unlocked Raids")
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Auto Unlock Dough Raid",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Auto Unlock Phoenix Raid",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.Main:AddSection("Dark Dragger + Valkyrie Helmet")
	local Q = Tabs.Main:AddToggle("Q", {
	...
	Tabs.Quests:AddSection("Pole / Thunder God's")
	local Q = Tabs.Quests:AddToggle("Q", {
		Title = "Auto Pole V1",
		Description = "",
		Default = false
	...
	Tabs.Quests:AddSection("Items Order Sword")
	local Q = Tabs.Quests:AddToggle("Q", {
		Title = "Auto Koko",
		Description = "",
		Default = false
