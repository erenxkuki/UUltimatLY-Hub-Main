	...
	Buttons = {
		{
			Title = "Copy Link",
			Callback = function()
				setclipboard("https://discord.gg/dPrTrSxhRX");
				WindUI:Notify({
					Title = "Notification",
					Content = "Copied",
					Icon = "bell",
...
AutoKillLavaGolemToggle = Tabs.SeaStackTab:Toggle({
	Title = "Auto Patch Prehistoric Island",
	Value = _G.Settings.SeaStack["Auto Patch Prehistoric Island"],
	Callback = function(state)
		_G.Settings.SeaStack["Auto Patch Prehistoric Island"] = state;
		StopTween(_G.Settings.SeaStack["Auto Patch Prehistoric Island"]);
		(getgenv()).SaveSetting();
	end
})
...
spawn(function()
	pcall(function()
		while wait(0.2) do
			if World3 then
				if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
					KitsuneStatusParagraph:SetDesc("Kitsune Island is Spawned");
				else
...
spawn(function()
	pcall(function()
		while wait(0.2) do
			if World3 then
				if game.Workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
					PrehistoricStatusParagraph:SetDesc("Prehistoric Island is Spawned");
				else
...
spawn(function()
	pcall(function()
		while wait(0.2) do
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
				FrozenStatusParagraph:SetDesc("Frozen Dimension Spawned");
			else
	...
	pcall(function()
		while wait(0.2) do
			if World2 or World3 then
				if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
					MirageStatusParagraph:SetDesc("Mirage Island is Spawned");
				else
...
spawn(function()
	while wait(0.2) do
		pcall(function()
			...
			if response then
				HakiDealerStatusParagraph:SetDesc("Master Of Auras Spawned");
			else
